        """
        Stream Parser Pe0lsw
        ====================
        Data engineering tool to enrich structured datasets with zero hassle.
...
def _write_output(rows: list, path: Path, suffix: str) -> None:
    ...
    if suffix == ".csv" and rows:
        ...
        def build_parser() -> argparse.ArgumentParser:
            p = argparse.ArgumentParser(prog=APP_NAME, description="Data engineering tool to enrich structured datasets with zero hassle.")
